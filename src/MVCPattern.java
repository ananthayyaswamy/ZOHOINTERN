...
public static void export(User user1) throws SQLException, IOException{
	...
	private static ArrayList<PhoneNumber> setPhoneValues(ArrayList<PhoneNumber> map) {
		map = new ArrayList<>();
		int choice = -1;
		while (true) {
	...
	private static ArrayList<EmailAddress> setEmailValues(ArrayList<EmailAddress> map) {
		map = new ArrayList<>();
		int choice = -1;
		while (true) {
	...
	private static ArrayList<Address> setAddressValues(ArrayList<Address> map) {
		map = new ArrayList<>();
		int choice = -1;
		while (true) {
