	...
	public static void main(String args[]) throws IOException, InterruptedException, SQLException {
		...
		while (condition) {
			...
			case 1:
				...
				PhoneNumberController phoneNumberController = new PhoneNumberController(contact.getPhoneNumber(),
						phoneNumberView);
				...
				EmailAddressController emailAddressController = new EmailAddressController(contact.getEmailAddress(),
						emailAddressView);
				emailAddressController.addEmailAddress(cid1, contact);
				AddressView addressView = new AddressView();
				AddressController addressController = new AddressController(contact.getAddress(), addressView);
			...
			case 2:
				...
				if (choice1 >= 1 && choice1 <= 4) {
					...
					PhoneNumberController phoneNumberController1 = new PhoneNumberController(contact1.getPhoneNumber(),
							phoneNumberView1);
					phoneNumberController1.editContact(contact1, fname, lname);
				} else if (choice1 == 6) {
					EmailAddressView emailAddressView1 = new EmailAddressView();
					EmailAddressController emailAddressController1 = new EmailAddressController(
							contact1.getEmailAddress(), emailAddressView1);
					emailAddressController1.editContact(contact1, fname, lname);

				} else if (choice1 == 7) {
					AddressView addressView1 = new AddressView();
					AddressController addressController1 = new AddressController(contact1.getAddress(), addressView1);
			...
			case 3:
				...
				PhoneNumberView phoneNumberView1 = new PhoneNumberView();
				PhoneNumberController phoneNumberController1 = new PhoneNumberController(contact2.getPhoneNumber(),
						phoneNumberView1);
				...
				EmailAddressView emailAddressView1 = new EmailAddressView();
				EmailAddressController emailAddressController1 = new EmailAddressController(contact2.getEmailAddress(),
						emailAddressView1);
				emailAddressController1.deleteContact(cid);
				AddressView addressView1 = new AddressView();
				AddressController addressController1 = new AddressController(contact2.getAddress(), addressView1);
			...
			case 4: {
				...
				PhoneNumberController phoneNumberController3 = new PhoneNumberController(contact3.getPhoneNumber(),
						phoneNumberView3);
				phoneNumberController3.SearchContact(li);
				EmailAddressView emailAddressView3 = new EmailAddressView();
				EmailAddressController emailAddressController3 = new EmailAddressController(contact3.getEmailAddress(),
						emailAddressView3);
				emailAddressController3.SearchContact(li);
				AddressView addressView3 = new AddressView();
				AddressController addressController3 = new AddressController(contact3.getAddress(), addressView3);
